...
final class PaymentBankAccountController extends AbstractController
{
    ...
    public function index(Request $request, PaymentBankAccountRepositoryInterface $accounts, CsrfTokenManagerInterface $csrf, VietQrBankClient $vietQrBankClient): Response
    {
