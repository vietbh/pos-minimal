...
enum Permission: string
{
    ...
    case PAYMENT_BANK_MANUAL_CONFIRM = 'PAYMENT_BANK_MANUAL_CONFIRM';
    case PAYMENT_BANK_ACCOUNT_MANAGE = 'PAYMENT_BANK_ACCOUNT_MANAGE';
    case SALES_POINT_MANAGE = 'SALES_POINT_MANAGE';
